...
<head>
    ...
    <style>
        ...
        .table-custom td {
            text-align: center;
            /* Menengahkan teks pada header dan sel */
            vertical-align: middle;
            /* Memposisikan konten secara vertikal di tengah sel */
            font-size: 14px;
        ...
        .table-custom tbody tr:nth-child(even) {
            ...
            /* Warna latar belakang bergantian pada baris genap */
        }
