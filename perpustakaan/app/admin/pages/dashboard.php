...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="alert alert-secondary" style="color: #383d41; background-color: #e2e3e5; border-color: #d6d8db;">
            Selamat Datang, <?= $_SESSION['fullname']; ?> di Administrator PustakaAlumni.
        </div>
        ...
        <div class="row">
            ...
            <h2 class="text-center" style="font-family: Quicksand, sans-serif; margin-top: 30px;">PustakaAlumni</h2>
            <p class="text-center">Alamat : Jl. Ir. Sutami No.36A, Jebres, Kota Surakarta, Jawa Tengah 57126</p>
