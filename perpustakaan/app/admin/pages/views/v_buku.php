                                            ...
                                            <div class="modal-content" style="border-radius: 5px;">
                                                ...
                                                <form action="pages/function/Buku.php?act=edit"
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Tipe Buku <small style="color: red;">* Wajib
                                                                    diisi</small></label>
                                                            <select class="form-control" name="tipeBuku">
                                                                <option selected value="<?= $row['tipe_buku']; ?>">
                                                                    <?= $row['tipe_buku']; ?> ( Dipilih Sebelumnya )
                                                                </option>
            ...
            <form action="pages/function/Buku.php?act=tambah" enctype="multipart/form-data" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Tipe Buku <small style="color: red;">* Wajib
                                diisi</small></label>
                        <select class="form-control select2" name="tipeBuku">
                        <option selected disabled>-- Harap Pilih Tipe Buku --</option>
                            <option value="E-Book">E-Book</option>
                            <option value="Hard Copy">Hard Copy</option>
                        </select>
                    </div>
