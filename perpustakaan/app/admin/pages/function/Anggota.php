...
if ($_GET['aksi'] == "tambah") {
    ...
    $sql = "INSERT INTO user(kode_user,nim,fullname,username,password,kelas,alamat,verif,role,join_date)
        VALUES('" . $kode_anggota . "','" . $nim . "','" . $fullname . "','" . $username . "','" . $password . "','" . $kelas . "','" . $alamat . "','" . $verif . "','" . $role . "','" . $join_date . "')";
