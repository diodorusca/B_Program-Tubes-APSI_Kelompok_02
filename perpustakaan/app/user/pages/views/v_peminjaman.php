                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                            ...
                            <section id="new">
                                ...
                                <form action="pages/function/Peminjaman.php?aksi=pinjam" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="tenggatPeminjaman" value="<?= date('d-m-Y', strtotime('+14 days')); ?>" readonly>
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="tab-pane" id="tgl-pengembalian">
                            <table class="table table-bordered table-custom" id="example1">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Nama Anggota</th>
